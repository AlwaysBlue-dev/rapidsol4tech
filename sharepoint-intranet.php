...
<?php
// Meta tags for SharePoint Intranet Development
$pageTitle = "SharePoint Intranet Development - RapidSol4Tech";
$pageDescription = "Transform internal communication and collaboration with our custom SharePoint intranet solutions. We design and implement user-friendly, secure intranet systems tailored to your organization’s needs.";
$pageKeywords = "SharePoint intranet development, SharePoint solutions, internal communication, collaboration tools, custom intranet, SharePoint design, secure intranet, RapidSol4Tech";
$ogTitle = "SharePoint Intranet Development - RapidSol4Tech";
$ogDescription = "Enhance internal communication and collaboration with our custom SharePoint intranet solutions. We provide secure, user-friendly intranet systems tailored to your organization's specific needs.";
$ogImage = "https://www.rapidsol4tech.com/img/logo.png";
$ogUrl = "https://www.rapidsol4tech.com/sharepoint-intranet.php";
$canonicalUrl = "https://www.rapidsol4tech.com/sharepoint-intranet.php";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 text-center text-lg-left">
                    ...
                    <p class="cta-text"> Elevate your internal communication with our SharePoint intranet solutions.</p>
                </div>
